...
metadata := {
	...
	"description": "azurerm_postgresql_server must set geo_redundant_backup_enabled = true (Basic \"B*\" SKUs exempt).",
	...
	"cvssv4": "",
	"cwss": "",
	"tags": ["terraform", "azure", "postgresql", "availability"],
}
...
findings contains finding if {
	...
	finding := {
		"rule_id": metadata.id,
		"message": sprintf("PostgreSQL server %q has no geo_redundant_backup_enabled = true.", [r.name]),
		"artifact_uri": r.path,
		"severity": "low",
		"level": "note",
		"start_line": 1,
